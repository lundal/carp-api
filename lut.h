...
#define LUT_AND4 (lut_t){0xFFFCFCC0, 0xFCC0C000, 0xFCC0C000, 0x80008000}
#define LUT_AND6 (lut_t){0x80008000, 0x00000000, 0x00000000, 0x00000000}
#define LUT_OR   (lut_t){0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFEFFFE}
