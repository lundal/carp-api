...
void writeState (bool_t state, int x, int y, int z) {
  uint64_t one = 1;
  insertDMA (0x0000000000000004 | (state ? (one << 63) : 0) | (z << 24) | (y << 16) | (x << 8));
}

void writeStates (uint64_t states, int x, int y, int z) {
